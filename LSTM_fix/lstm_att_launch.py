...
def build_model(tparams, options):
    ...
    h_pos_text = attention(tparams, h_pos_text, pos_relation, options, prefix='attention', mask=mask[:, 0:r.shape[0]])
...
def build_test(tparams, options):
    ...
    end_step = attention(tparams, rt_text, rel_emb, options, prefix='attention', mask=mask)
    ###
    # end_step = rt_text[-1]
